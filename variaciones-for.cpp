...
int main(){
    ...
    int x, y; float z;
    //Imprime números de 1 en 1 hasta el 100 mientras x<=100, variación: incrementos de 1 en 1 y 2 en 2
    ...
    //variaciones del for. Se permite el uso de "," para uso de dos o más variables de control.
    ...
    system("PAUSE");    //termina cuando se teclea el 123 en x, no hay variación en la variable de ctrl //inicialización antes del for
    x=1;
    for(;x<=10;){
        printf("%d\n",x);
    ...
    //bucles sin cuerpo (retardadores)
    cout<<"Hola mundo\n";
    for(x=0;x<1999999999;x++);//el ; hace que el ciclo concluya aquí
